...
export function Reg() {
	...
	const onSubmit: SubmitHandler<FieldsValue> = ({ name, email, password }) => {
		alert.error("Регистрация в данный момент не работает!");
	};
	...
	return (
		<div className="form-entry">
			<div className="form-entry__wrapper">
				<div className="form-entry__title">Регистрация в Yoldi Agency</div>
